...
public abstract class Entity {
	...
	// Appel� quand le collectable est en train de se faire collecter
	...
	// Teste les collisions avec d'autres entit�s
	...
	public static void AddEntityFromServer(HashMap<String, String> hash) {
		// Si il y a une class sp�cifi�e dans le hash
		if (hash.containsKey("class")) {
			...
			default:
				MinigameDrill.println("Pas de classe trouv�e pour :", hash);
				break;
			}
		} else {
			System.out.println("Pas de sp�cification de classe : " + hash);
		}
	}
	...
	public static void add(JSONObject json) {
		try {
			// On doit pouvoir r�cup le nom de la class et de l'instancier ici
