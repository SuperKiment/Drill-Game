class ParticlesManager {
  ...
  public void Display() {
    ...
    for (int i=0; i<AllParticles.size(); i++) {
      ...
      if (p.mort) AllParticles.remove(i);
    }
  ...
  public void addParticles(PVector p) {
    ...
    Type de forme
     ...
     Vitesse
     Ralentissement (damp)
     Limite de temps (si spécifié, autrement disparait par manque de vitesse) / 0
     Nombre de Particle
     */
  ...
  private class Particles {
    ...
    Type de forme
       ...
       Vitesse
       Ralentissement (damp)
       Limite de temps (si spécifié, autrement disparait par manque de vitesse)
       */
      ...
      public void Update() {
        ...
        if (!isTimed) {
          ...
          if (millis() - timer > timeLimit) isMort = true;
        }
      }
